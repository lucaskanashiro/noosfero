...
ActiveRecord::Schema.define(version: 20160406145351) do
  ...
  add_index "environment_federated_networks", ["environment_id", "federated_network_id"], name: "index_environment_federated_network", unique: true, using: :btree
  add_index "environment_federated_networks", ["environment_id"], name: "index_environment_federated_networks_on_environment_id", using: :btree
  add_index "environment_federated_networks", ["federated_network_id"], name: "index_environment_federated_networks_on_federated_network_id", using: :btree
  ...
  add_index "federated_networks", ["url"], name: "index_federated_networks_on_url", unique: true, using: :btree
